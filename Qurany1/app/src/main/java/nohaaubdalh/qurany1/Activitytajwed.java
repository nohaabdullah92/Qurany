...
public class Activitytajwed extends AppCompatActivity {
    DatabaseHelper1 db = new DatabaseHelper1(this);
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_activitytajwed);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(Activitytajwed.this,Showajwed.class);
    ...
    private boolean copyDatabase(Activitytajwed context) {
